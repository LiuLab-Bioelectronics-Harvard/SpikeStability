...
from . import brMiscFxns

# Version control set/check
brpylib_ver        = "1.3.2"
brmiscfxns_ver_req = "1.2.0"
if brMiscFxns.brmiscfxns_ver.split('.') < brmiscfxns_ver_req.split('.'):
...
class NevFile:
    ...
    def __init__(self, datafile=''):
        ...
        # Run brMiscFxns.openfilecheck and open the file passed or allow user to browse to one
        self.datafile = brMiscFxns.openfilecheck('rb', file_name=self.datafile, file_ext='.nev', file_type='Blackrock NEV Files')
...
class NsxFile:
    ...
    def __init__(self, datafile=''):
        ...
        # Run brMiscFxns.openfilecheck and open the file passed or allow user to browse to one
        self.datafile = brMiscFxns.openfilecheck('rb', file_name=self.datafile, file_ext='.ns*', file_type='Blackrock NSx Files')
